...
- Settings adapter for typed settings (#193).
...
- Keithley 4215 CVU aperture filter factor parameter (#191).
...
[0.21.7]: https://github.com/hephy-dd/diode-measurement/compare/0.21.6...0.21.7
