...
from diode_measurement.drivers.keithley.k2410 import (
    K2410Adapter,
    SourceFunction,
    TControlMode,
    TerminalsLocation,
...
def test_k2410_adapter(res):
    ...
    res.buffer = ["1"]
    assert d.set_route_terminals(TerminalsLocation.REAR) is None
    ...
    res.buffer = ["1"]
    assert d.set_sense_average_tcontrol(TControlMode.REP) is None
