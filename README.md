...
```bash
pip install https://github.com/hephy-dd/diode-measurement/archive/refs/tags/0.30.1.tar.gz
```
...
```bash
git clone https://github.com/hephy-dd/diode-measurement.git -b 0.30.1
