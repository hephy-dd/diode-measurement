...
```bash
pip install https://github.com/hephy-dd/diode-measurement/archive/refs/tags/0.31.2.tar.gz
```
...
```bash
git clone https://github.com/hephy-dd/diode-measurement.git -b 0.31.2
